        ...
        <div className="sidebarparent">
            ...
            <aside id="colorlib-aside" className="border js-fullheight main">
                <div className="text-center">
                    ...
                    <h1 id="colorlib-logo"><a href="index.html">Deepa Narayanan </a></h1>
                    <span className="email"><FaMailBulk/> deepapriya393@gmail.com</span>
                    <br></br>
                </div>
                ...
                <div className="colorlib-footer">
                        <SocialIcon url="https://www.linkedin.com/in/deepa-narayanan-2b298a92" />

                    <p><small><i>I will test, so that clients don't have to..</i></small></p>
                </div>
            </aside>
        </div>
    </div>
